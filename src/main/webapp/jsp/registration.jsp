                                ...
                                <div class="col-md-12 card">
                                    <div class="row align-items-center">
                                            ...
                                            <!-- Content - Form for registering -->
                                                <form class="reg-form" action="#" method="post" name="registration-form1">
												 ...
												 <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
												  <div class="modal-dialog modal-dialog-centered">
												    <div class="modal-content">
												      ...
												      <p id="ptag"></p>
														<form class="reg-form"  id="formId" action="registrationprocess" method="post" name="registration-form">
		                                                    <label class="reg-lbl">Registration</label>
		                                                    <div class="form-group">
												      ...
												      <div class="modal-footer">
												        ...
												        <button id="subutton1" type="submit" class="btn btn-primary" form="formId">SUBMIT</button>
												      </div>
												    </div>
												  </div>
												</div>
