<%@page import="model.Politic_model"%>
...
<body>
	...
	<div class="container" style="text-align: center">
		...
		<%
		//Create of objects via getAtribute from result servlet
			Politic_model politic1 = new Politic_model();
		Politic_model politic2 = new Politic_model();
		Politic_model politic3 = new Politic_model();
		politic1 = (Politic_model) request.getAttribute("politic1");
		politic2 = (Politic_model) request.getAttribute("politic2");
		politic3 = (Politic_model) request.getAttribute("politic3");
		%>
									...
									<div class="col-sm 6" style="margin: auto;">
										<div class="result_text">
											...
											<!-- Send and redirect politic id to result detail servlet -->
												<a
													href='/result_detail_servlet?id=<%out.println(politic1.getPoliticID());%>'>
													<%
									...
									<div class="col-sm 6" style="margin: auto;">
										<div class="result_text" style="width: 130px; margin: auto">
											<h2
												...
												<a
													href='/result_detail_servlet?id=<%out.println(politic2.getPoliticID());%>'>
													<%
									...
									<div class="col-sm 6" style="margin: auto;">
										<div class="result_text" style="width: 130px; margin: auto">
											<h2 style="font-weight: normal; font-size: 24px; width: 100%">
												<a
													href='/result_detail_servlet?id=<%out.println(politic3.getPoliticID());%>'>
													<%
