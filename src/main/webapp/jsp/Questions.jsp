			...
			<div class="col-md-12 mainColumn">
				<div class="row">
					...
					<div class="col-md-11">
						...
						<%//gets all questions 
									ArrayList<AllQuestions> questionsList=(ArrayList<AllQuestions>)request.getAttribute("questions"); 
				...
				<div class="row">
					<div class="col-md-1 arrowColumn firstArrowColumn">
						<a class="arrow leftArrow" href="#"><i class="fas fa-chevron-left"></i></a>
					</div>
					<div class="col-md-10 mainMainColumn">
						...
						<article class='forMainBox' id='articleWithQuestions' data-questions='<% 
								for (int i=0; questionsList!=null && i<questionsList.size();i++){//loops throung question objects
									AllQuestions q = questionsList.get(i);
									out.print(q.getId() + "." + q.getQuestion() + "_");
								}
						%>'>
					...
					<div class="col-md-1 arrowColumn thirdArrowColumn">
						<a class="arrow rightArrow" href="#"><i class="fas fa-chevron-right"></i></a>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8">
						...
						<form id="finalUserAnswersForm1" name="printAnswers1" action="storeresults" method="POST">
